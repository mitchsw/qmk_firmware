...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LALT,        KC_LCTRL,       KC_SLASH,       KC_BSLASH,      KC_LGUI,                                                                                                        KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_NO,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_NO,          KC_NO,          KC_LCBR,        KC_RCBR,        KC_AMPR,        KC_AT,          KC_LBRACKET,                                    KC_RBRACKET,    KC_EQUAL,       KC_PLUS,        KC_TILD,        KC_NO,          KC_NO,          KC_F12,
    KC_NO,          KC_NO,          KC_LPRN,        KC_RPRN,        KC_HASH,        KC_DLR,                                                                         KC_ASTR,        KC_PERC,        KC_GRAVE,       KC_NO,          KC_NO,          WEBUSB_PAIR,         
    KC_NO,          KC_PLAYPAU,     KC_LABK,        KC_RABK,        KC_CIRC,        KC_PIPE,        KC_LABK,                                        KC_RABK,        KC_EXLM,        KC_QUES,        KC_NO,          KC_NO,          KC_NO,          KC_NO,         
    KC_NO,          KC_NO,          KC_LBRACKET,    KC_RBRACKET,    KC_NO,                                                                                                          LCTL(KC_LEFT),  LCTL(KC_DOWN),  LCTL(KC_UP),    LCTL(KC_RIGHT), KC_NO,
