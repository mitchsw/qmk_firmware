...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_NO,                                          KC_NO,          KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_NO,
    ...
    KC_LALT,        KC_LCTRL,       LCTL(KC_LEFT),  LCTL(KC_RIGHT), KC_LGUI,                                                                                                        KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_NO,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_NO,          KC_NO,          KC_LCBR,        KC_RCBR,        KC_AMPR,        KC_AT,          KC_NO,                                          KC_NO,          KC_EQUAL,       KC_PLUS,        KC_LABK,        KC_RABK,        KC_NO,          KC_F12,
    KC_NO,          KC_NO,          KC_LPRN,        KC_RPRN,        KC_HASH,        KC_DLR,                                                                         KC_ASTR,        KC_PERC,        KC_LPRN,        KC_RPRN,        KC_NO,          WEBUSB_PAIR,         
    KC_NO,          KC_PLAYPAU,     KC_SLASH,       KC_BSLASH,      KC_CIRC,        KC_PIPE,        KC_NO,                                          KC_NO,          KC_EXLM,        KC_QUES,        KC_TILD,        KC_GRAVE,       KC_NO,          KC_NO,         
    KC_NO,          KC_NO,          LCTL(KC_DOWN),  LCTL(KC_UP),    KC_NO,                                                                                                          KC_HOME,        KC_PGDOWN,      KC_PGUP,        KC_END,         KC_NO,
