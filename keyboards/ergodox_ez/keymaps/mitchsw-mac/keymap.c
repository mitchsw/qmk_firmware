...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_NO,                                          KC_NO,          KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_PGUP,
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_NO,                                          KC_NO,          KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_PGDOWN,
    KC_UNDS,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_COLN,
    KC_MINUS,       KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_NO,                                          KC_NO,          KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_QUOTE,       KC_DQUO,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_NO,          KC_NO,          KC_LCBR,        KC_RCBR,        KC_AMPR,        KC_AT,          KC_NO,                                          KC_NO,          KC_EQUAL,       KC_PLUS,        KC_TILD,        KC_NO,          KC_NO,          KC_F12,
    KC_NO,          KC_NO,          KC_LPRN,        KC_RPRN,        KC_HASH,        KC_DLR,                                                                         KC_ASTR,        KC_PERC,        KC_GRAVE,       KC_NO,          KC_NO,          WEBUSB_PAIR,         
    KC_NO,          KC_PLAYPAU,     KC_LABK,        KC_RABK,        KC_CIRC,        KC_PIPE,        KC_NO,                                          KC_NO,          KC_EXLM,        KC_QUES,        KC_NO,          KC_NO,          KC_NO,          KC_NO,         
